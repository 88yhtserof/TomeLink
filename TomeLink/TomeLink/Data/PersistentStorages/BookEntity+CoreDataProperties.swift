...
extension BookEntity {
    ...
    @NSManaged public var archive: NSSet
...
extension BookEntity {
    ...
    @NSManaged public func addToArchive(_ value: ArchiveEntity)

    @objc(removeArchiveObject:)
    @NSManaged public func removeFromArchive(_ value: ArchiveEntity)
